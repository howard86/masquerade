...
struct FormatJSONIntent: ForegroundMasqueradeIntent {
  ...
  static var parameterSummary: some ParameterSummary { Summary("Format \(\.$input)") }
...
struct ConvertTimestampIntent: ForegroundMasqueradeIntent {
  ...
  static var parameterSummary: some ParameterSummary { Summary("Convert \(\.$input)") }
...
struct RunSavedWorkflowIntent: ForegroundMasqueradeIntent {
  ...
  static var parameterSummary: some ParameterSummary { Summary("Run \(\.$workflow) with \(\.$input)") }
