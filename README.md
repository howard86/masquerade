...
Twenty-eight tools, each reachable from the Home screen's grid or via search:
...
- **Markdown** — preview headings, emphasis, code, lists, links, and tables with inert local rendering.
